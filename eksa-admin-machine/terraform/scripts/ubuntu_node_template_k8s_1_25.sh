...
file=$(sudo -Hiu ubuntu ls /home/ubuntu/eks-anywhere-downloads/1.25/eks-distro/ | grep kubernetes)
...
image-builder build --os ubuntu --hypervisor vsphere --release-channel 1-25 --vsphere-config $HOME/vsphere-connection.json

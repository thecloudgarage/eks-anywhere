...
read -p 'Final name for EKS-A ubuntu node template, e.g. ubuntu-2004-kube-v1.23: ' ubuntu_template_name
...
file=$(sudo -Hiu ubuntu ls /home/ubuntu/eks-anywhere-downloads/1.23/eks-distro/ | grep kubernetes)

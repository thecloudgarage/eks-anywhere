...
file=$(sudo -Hiu ubuntu ls /home/ubuntu/eks-anywhere-downloads/1.28/eks-distro/ | grep kubernetes)
...
image-builder build --os ubuntu --hypervisor vsphere --release-channel 1-28 --vsphere-config $HOME/vsphere-connection.json
export vsphere_templates_folder_full_path=/$GOVC_DATACENTER/vm/$vsphere_templates_folder
mv $HOME/ubuntu-2004-kube-1-28.ova $HOME/$ubuntu_template_name.ova

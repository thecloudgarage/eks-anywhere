#!/bin/bash
vsphere_library_name=eks-anywhere-template-$RANDOM
govc library.create "$vsphere_library_name"
sed -i "s/vsphere_library_name/$vsphere_library_name/g" $HOME/vsphere-connection.json
...
govc library.import $vsphere_library_name /home/image-builder/ubuntu-2004-kube-v1.21.14.ova
govc library.deploy -pool Test -folder $vsphere_templates_folder_full_path /$vsphere_library_name/ubuntu-2004-kube-v1.21.14 ubuntu-2004-kube-v1.21.14
